<template>
  <div id="slider">
    <div class="window" @mouseover="stop" @mouseleave="play">
      ...
      <ul class="direction">
        <li class="left" @click="move(1226, 1, speed)">
        ...
        <li class="right" @click="move(1226, -1, speed)">
...
export default {
  ...
  data () {
    return {
      sliders:[
        {
          img:'../../static/swiperImages/1.jpg'
        },
        {
          img:'../../static/swiperImages/2.jpg'
        },
        {
          img:'../../static/swiperImages/3.jpg'
        },
        {
          img:'../../static/swiperImages/4.jpg'
        },
        {
          img:'../../static/swiperImages/5.jpg'
        }
      ],
      currentIndex:1,
      distance:-1226,
  ...
  methods:{
    ...
    move(offset, direction, speed) {
      ...
      direction === -1 ? this.currentIndex += offset/1226 : this.currentIndex -= offset/1226
    ...
    animate(des, direc, speed) {
      ...
      this.temp = window.setInterval(() => {
        if ((direc === -1 && des < this.distance) || (direc === 1 && des > this.distance)) {
          ...
          window.clearInterval(this.temp)
          this.distance = des
          if (des < -6130) this.distance = -1226
          if (des > -1226) this.distance = -6130
        }
      }, 20)
    },
    jump(index) {
