<template>
  <div>
    ...
    <nav-bread><span>我的购物车</span></nav-bread>
              ...
              <li v-for="item in cartList">
                ...
                <div class="cart-tab-5">
                  <div class="cart-item-opration">
                    <a href="javascript:;" class="item-edit-btn" @click="deleteCart(item)">
    ...
    <modal :mdShow="mdShowDelete" @close="closeModal">
      <p slot="message">
        是否要从购物车删除？
      </p>
      <div slot="btnGroup">
        <a href="javascript:;" class="btn btn-m" @click="deleteConfirm">删除</a>
